        ...
        <div>
          ...
          <div className="flex items-center">
            ...
            <input
              ...
              className="flex-1 h-8 px-4 text-lg border-0 border-b-2 border-gray-600 rounded-none bg-transparent outline-none text-gray-900 placeholder:text-gray-400 font-times-new-roman font-semibold"
            />
            <div className="ml-4 flex items-center font-times-new-roman">
              ...
              <input
                ...
                className="w-36 h-8  text-2xl text-center border-b-2  rounded-none border-x-0 border-t-0 shadow-none border-b-gray-600 outline-none leading-0   text-gray-900 font-bold "
              />
            </div>
          </div>
        </div>
          ...
          <div className=" mb-1 flex items-center ">
            {amountCents > 0 ? (
              <div className='flex items-end  gap-x-5  w-full justify-between'>
                <div className="text-lg border-b-2 w-full font-times-new-roman px-4  border-gray-600 min-h-[36px] text-gray-900 leading-tight flex items-center gap-x-2 font-semibold  italic uppercase">
        ...
        <div className="grid grid-cols-5 justify-between items-end">
          ...
          <div className="col-span-2 flex items-center gap-x-3">
             ...
             <input
              ...
              className="w-full h-6 border-0 border-b-2 border-gray-600 rounded-none bg-transparent outline-none text-gray-900 placeholder:text-gray-400"
              maxLength={140}
            />
          </div>
            <div></div>
