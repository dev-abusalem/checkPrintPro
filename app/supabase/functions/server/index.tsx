...
app.post("/make-server-69821625/signup", async (c) => {
  try {
    ...
    const { data, error } = await supabase.auth.admin.createUser({
      ...
      // Automatically confirm the user's email since an email server may not be configured
      email_confirm: true
    });
    ...
    await kv.set(orgId, organization);
